...
Select blender-osc-camera.zip

Activate "OSC Camera Sync"

Usage

Select a camera

Properties Panel → Camera Data → OSC Camera Sync

Configure host and port (default: 127.0.0.1:9000)

Adjust the OSC address prefix (default: /camera)
...
Set the port to the same as in the add-on (e.g. 9000)

The parameters will appear automatically under the configured prefix
